...
def format():
    ...
    jabbrev = json.load(open("jabbrev.json"))
    # This is a temporary solution, this db should be replaced by those from 
    ...
    for entry in bib_db.entries:
        ...
        try:
            # replace the journal name with its abbreviation    
            if hentry['journal'] in jabbrev['default']['container-title']:
                hentry['journal'] = jabbrev['default']['container-title'][hentry['journal']]
        except:
            pass
